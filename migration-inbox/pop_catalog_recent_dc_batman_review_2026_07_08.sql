...
-- False-positive DC row: this is Jurassic Park, not DC.
...
set
  ...
  needs_review = false
where upc = '889698717366';

-- Bullseye as Superman is primarily a Target Ad Icons row.
update public.pop_catalog
set
...
set current_value = 9.00
where pop_catalog_id = (select id from public.pop_catalog where upc = '889698372541')
...
-- Tighten recent DC/Batman sets and vault statuses.
update public.pop_catalog
set vault_status = 'Vaulted'
where upc in ('889698477055', '889698477062');
...
where upc = '889698866422';

update public.user_collection_items
set current_value = 24.48
where pop_catalog_id = (select id from public.pop_catalog where upc = '889698866422')
  and coalesce(current_value, 0) = 24.58;
...
where upc in (
  ...
  '889698863711','889698863728','889698863704','889698863698','889698862257',
  '889698862240','889698744225','830395033723','889698818667','889698806879',
  '889698787741','889698372534','889698668590','889698372480','889698372541',
  '889698372145','889698717366','889698871877','889698866422'
)
order by upc;
